...
var InputSpread = function (_Component) {
    _inherits(InputSpread, _Component);
    ...
    function InputSpread() {
        ...
        _classCallCheck(this, InputSpread);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = InputSpread.__proto__ || Object.getPrototypeOf(InputSpread)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidMount = function () {
            var firstField = document.querySelectorAll('input[name="field_0"]');
            ...
            var current = document.querySelectorAll('input[name="field_' + index + '"]');
            var next = document.querySelectorAll('input[name="field_' + (index + 1) + '"]');
            var isAlpha = e.keyCode >= 65 && e.keyCode <= 90;
            var isNumeric = e.keyCode >= 48 && e.keyCode <= 57;
            ...
            var digitFields = Array(count).fill().map(function (_, index) {
                return _react2.default.createElement('input', _extends({ required: true, key: index, name: 'field_' + index, maxLength: '1', autoComplete: 'off', onKeyUp: function onKeyUp(e) {
