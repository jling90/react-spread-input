...
var Spread = function (_Component) {
    ...
    function Spread(props) {
        ...
        Array(props.count).fill().map(function (_, index) {
            return values[index] = '';
        });
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.parse = function (e, count) {
        var clipboard = e.clipboardData.getData('Text') || '';
        var limit = Math.min(clipboard.length, count);
        var characters = clipboard.substr(0, limit);
        ...
        characters.split('').map(function (character, index) {
            return values[index] = character;
        });
    };

    this.keyDown = function (e, index) {
        var prev = _this2['rsi_' + (index - 1)];
        var current = _this2['rsi_' + index];
        var isBackspace = e.keyCode === 8;
        var hasValue = !!current.value && current.value !== '';
    ...
    this.keyUp = function (e, index) {
        var current = _this2['rsi_' + index];
        var next = _this2['rsi_' + (index + 1)];
        var isNumeric = e.keyCode >= 48 && e.keyCode <= 57 || /^\d$/.test(e.key);
    ...
    this.change = function (e, index, onChange) {
        var values = _this2.state.values;
    ...
    this.declareReference = function (input, index) {
        _this2['rsi_' + index] = input;
    };
    ...
    this.render = function () {
        var _props = _this2.props,
            ...
            props = _objectWithoutProperties(_props, ['count', 'onChange']);

        var keyUp = _this2.keyUp,
            keyDown = _this2.keyDown,
            paste = _this2.paste,
            change = _this2.change,
            declareReference = _this2.declareReference;

        var maxLength = 1;
        var autoComplete = 'off';
        var type = 'tel';
        var required = 'required';
        var defaults = { maxLength: maxLength, autoComplete: autoComplete, type: type, required: required };
            ...
            Array(count).fill().map(function (_, index) {
                return _react2.default.createElement('input', _extends({
                    ...
                    ref: function ref(input) {
                        return declareReference(input, index);
                    },
                    onKeyUp: function onKeyUp(e) {
                        return keyUp(e, index);
                    },
                    onKeyDown: function onKeyDown(e) {
                        return keyDown(e, index);
                    },
                    onPaste: function onPaste(e) {
                        return paste(e, count);
                    },
                    onChange: function onChange(e) {
                        return change(e, index, _onChange);
                    }
                }, defaults, props));
            })
        );
...
(function webpackMissingModule() { throw new Error("Cannot find module \"/Users/haydenbleasel/Projects/react-spread-input/index.jsx\""); }());
...
var Spread = function (_Component) {
    ...
    function Spread() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Spread.__proto__ || Object.getPrototypeOf(Spread)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidMount = function () {
            var firstField = _this.rsi_0;

            if (firstField.length) {
                firstField[0].focus();
            }
        }, _this.verifyKey = function (e) {
            var isAlpha = e.keyCode >= 65 && e.keyCode <= 90;
            var isNumeric = e.keyCode >= 48 && e.keyCode <= 57;
        ...
        }, _this.moveNext = function (e, index) {
            var current = _this['rsi_' + index];
            var next = _this['rsi_' + (index + 1)];
            var isAlpha = e.keyCode >= 65 && e.keyCode <= 90;
            var isNumeric = e.keyCode >= 48 && e.keyCode <= 57;
            ...
            return true;
        }, _this.declareReference = function (input, index) {
            _this['rsi_' + index] = input;
        }, _this.render = function () {
            var _this$props = _this.props,
                count = _this$props.count,
                props = _objectWithoutProperties(_this$props, ['count']);

            var _this2 = _this,
                moveNext = _this2.moveNext,
                verifyKey = _this2.verifyKey,
                declareReference = _this2.declareReference;
            ...
            return _react2.default.createElement(
                ...
                { className: 'input-spread' },
                Array(count).fill().map(function (_, index) {
                    return _react2.default.createElement('input', _extends({ required: true, key: index, ref: function ref(input) {
                            return declareReference(input, index);
                        }, maxLength: '1', autoComplete: 'off', onKeyUp: function onKeyUp(e) {
                            return moveNext(e, index);
                        }, onKeyDown: verifyKey }, props));
                })
            );
